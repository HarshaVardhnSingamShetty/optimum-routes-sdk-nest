...
var PancakeswapPair = require('./src/factories/router/pancakeswap-router.factory.ts').PancakeswapPair;
...
var main = function () { return __awaiter(_this, void 0, void 0, function () {
    var pancakeswapPair, pancakeswapPairFactory;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                pancakeswapPair = new PancakeswapPair({
                ...
                return [4 /*yield*/, pancakeswapPair.createFactory()
            ...
            case 1:
                pancakeswapPairFactory = _a.sent();
                return [2 /*return*/];
        }
    });
}); };
